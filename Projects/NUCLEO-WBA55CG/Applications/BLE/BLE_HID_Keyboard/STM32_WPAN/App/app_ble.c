...
static const char a_GapDeviceName[] = {  'H', 'i', 'd', 'M', 'X' }; /* Gap Device Name */
...
{
  HIDS_APP_UpdateButtonState(B1, HAL_GPIO_ReadPin(B1_GPIO_PORT, B1_PIN) == GPIO_PIN_RESET);
  return;
}

void APPE_Button2Action(void)
{
  HIDS_APP_UpdateButtonState(B2, HAL_GPIO_ReadPin(B2_GPIO_PORT, B2_PIN) == GPIO_PIN_RESET);
  return;
}

void APPE_Button3Action(void)
{
  HIDS_APP_UpdateButtonState(B3, HAL_GPIO_ReadPin(B3_GPIO_PORT, B3_PIN) == GPIO_PIN_RESET);
  return;
}
#endif
